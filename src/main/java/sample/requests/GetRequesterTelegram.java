 ...
 */
public class GetRequesterTelegram implements IGetRequester{
    ...
    public boolean sendGETRequest(IRequestData data) {
        ...
        DataForGetTelegram obtainedData = (DataForGetTelegram) data;
        String serverURL = obtainedData.getMainURL() + obtainedData.getMessage() + obtainedData.getKeyURL();
